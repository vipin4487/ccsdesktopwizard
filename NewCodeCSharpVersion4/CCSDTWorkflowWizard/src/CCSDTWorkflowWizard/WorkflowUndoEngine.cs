namespace CCSDTWorkflowWizard
{
    ...
    internal class WorkflowUndoEngine : UndoEngine
    {
        ...
        public string UndoText
        {
            get
            {
                return (this.CanUndo ? this.undoUnits.Peek().Name : string.Empty);
            }
        }
        ...
        public string RedoText
        {
            get
            {
                return (this.CanRedo ? this.redoUnits.Peek().Name : string.Empty);
            }
        }
