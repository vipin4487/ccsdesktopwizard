    ...
    public class ParameterEditorDlg : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (this.dgvParameters.SelectedRows.Count > 0)
            {
                ...
                int index = this.dgvParameters.SelectedRows[0].Index;
                ArrayList dataSource = (ArrayList) this.dgvParameters.DataSource;
        ...
        private void CreateCallVarDataSource()
        {
            ...
            List<string> callVariableNames = this.workflow.CallVariableNames;
            foreach (string str in callVariableNames)
            {
        ...
        {
            if (this.dgvParameters.SelectedRows == null)
            {
                this.btnDelete.Enabled = false;
            }
            else
