    ...
    public class ImageButton : ButtonBase
    {
        ...
        public override string GetHtml
        {
            get
            {
                ...
                {
                    builder.Append(" onclick=\"window.open(" + DBHelper.AddSingleQuotes(this.UrlOnClick) + ", " + DBHelper.AddSingleQuotes("_blank") + ");\"");
                }
                builder.Append(" />");
