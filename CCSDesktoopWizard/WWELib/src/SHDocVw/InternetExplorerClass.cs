namespace SHDocVw
{
    ...
    [ComImport, ComSourceInterfaces("SHDocVw.DWebBrowserEvents2\0SHDocVw.DWebBrowserEvents\0"), DefaultMember("Name"), Guid("0002DF01-0000-0000-C000-000000000046"), TypeLibType((short) 2), ClassInterface((short) 0)]
    public class InternetExplorerClass : IWebBrowser2, InternetExplorer, DWebBrowserEvents2_Event, IWebBrowserApp, DWebBrowserEvents_Event
    {
        ...
        [DispId(-525)]
        public virtual tagREADYSTATE ReadyState { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-525), TypeLibFunc((short) 4)] get; }
        ...
        [DispId(-525)]
        public virtual tagREADYSTATE SHDocVw.IWebBrowser2.ReadyState { [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-525), TypeLibFunc((short) 4)] get; }
