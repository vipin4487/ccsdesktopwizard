namespace SHDocVw
{
    ...
    [ComImport, Guid("B45FF030-4447-11D2-85DE-00C04FA35C89"), ClassInterface((short) 0), ComSourceInterfaces("SHDocVw._SearchAssistantEvents\0"), TypeLibType((short) 0x12)]
    public class SearchAssistantOCClass : ISearchAssistantOC3, SearchAssistantOC, _SearchAssistantEvents_Event
    {
