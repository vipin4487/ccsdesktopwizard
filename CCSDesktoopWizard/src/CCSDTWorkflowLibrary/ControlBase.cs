    ...
    public abstract class ControlBase : Activity
    {
                ...
                switch (this.MinRowHeight)
                {
                    case MinHeightType.Default:
                        if (this is ReadOnlyText)
                        {
                            ...
                            if ((((text.SourceCallVariable == null) || (text.SourceCallVariable.Length <= 0)) && ((text.InitialValue == null) || (text.InitialValue.Length <= 0))) || (text.LabelText == null))
                            {
                                flag1 = false;
                            }
                            else
                            {
                                flag1 = text.LabelText.Length > 0;
                            }
                            if (flag1)
                            {
        ...
        public virtual CustomCCSDTWorkflowBase GetParentWorkflow
        {
            get
            {
                ...
                return (!(parent is CustomCCSDTWorkflowBase) ? null : ((CustomCCSDTWorkflowBase) parent));
            }
        }
    }
}
