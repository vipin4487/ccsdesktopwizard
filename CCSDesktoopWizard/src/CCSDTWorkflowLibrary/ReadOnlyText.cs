        ...
        public override string GetHtml
        {
            get
            {
                ...
                else if ((base.SourceCallVariable != null) && (base.SourceCallVariable.Length > 0))
                {
                    ...
                    {
                        string[] textArray1 = new string[] { "<td class=\"", this.GetClassForRow, this.GetClassForControl, " colInstructionStyle\" colspan=\"2\" align=\"center\" ><span id='", base.Name, "' style=\"float: none;\"><callvar, ", this.GetCallVarReservedWord, "></span>" };
