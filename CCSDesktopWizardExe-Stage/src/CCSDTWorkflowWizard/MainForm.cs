    ...
    public class MainForm : Form, ISite, IServiceProvider
    {
        ...
        public bool Compile(bool showMessage)
        {
            ...
            try
            {
                ...
                WorkflowCompilerParameters parameters = new WorkflowCompilerParameters(assemblyNames) {
                    OutputAssembly = $"{this.WorkflowName}.dll"
                };
        ...
        private void InitializeComponent()
        {
            try
            {
                ...
                base.Name = "MainForm";
                this.Text = "VCC Desktop Workflow Wizard";
        ...
        public bool Run()
        {
            ...
            this.workflowRuntime.CreateWorkflow(this.compilerResults.CompiledAssembly.GetType($"{base.GetType().Namespace}.{this.WorkflowName}")).Start();
            return true;
        }
        ...
        public bool Save(bool showMessage)
        {
            ...
            try
            {
                ...
                node.Value = $"{base.GetType().Namespace}.{this.WorkflowName}";
        ...
        private void tsbHelp_ViewLogFile_Click(object sender, EventArgs e)
        {
            try
            {
                Interaction.Shell("Notepad " + this.logFilePath, 1, false, -1);
            }
            catch (Exception exception)
            {
        ...
        public string WorkflowName =>
            (this.currentWorkflow == null) ? string.Empty : this.currentWorkflow.Name;
