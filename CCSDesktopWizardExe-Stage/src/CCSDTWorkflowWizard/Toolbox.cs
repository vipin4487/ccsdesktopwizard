namespace CCSDTWorkflowWizard
{
    ...
    public class Toolbox : Panel, IToolboxService
    {
        ...
        public ToolboxItem DeserializeToolboxItem(object dataObject) => 
            this.DeserializeToolboxItem(dataObject, null);
        ...
        public ToolboxItem DeserializeToolboxItem(object data, IDesignerHost host)
        {
            ...
            if (item == null)
            {
                ToolboxItemCreatorCallback callback = this.FindToolboxItemCreator(dataObj, host, out string str);
                if (callback > null)
                {
        ...
        public bool IsToolboxItem(object dataObject) => 
            this.IsToolboxItem(dataObject, null);
        ...
        public bool IsToolboxItem(object data, IDesignerHost host)
        {
            ...
            return (dataObj.GetDataPresent(typeof(ToolboxItem)) || (this.FindToolboxItemCreator(dataObj, host, out _) > null));
        }
        ...
        public CategoryNameCollection CategoryNames =>
            new CategoryNameCollection(new string[] { "Workflow" });
